            ...
            <div className="impressum-card card shadow-lg border-0">
                <div className="p-4 text-center">
                    ...
                    <form className="contact-form">
                        <div className="mb-3">
                            <input type="text" className="form-control" placeholder="Dein Name" required />
                        </div>
                        <div className="mb-3">
                            <input type="email" className="form-control" placeholder="Deine E-Mail" required />
                        </div>
                        <div className="mb-3">
                            <textarea className="form-control" rows={4} placeholder="Deine Nachricht" required></textarea>
                        </div>
